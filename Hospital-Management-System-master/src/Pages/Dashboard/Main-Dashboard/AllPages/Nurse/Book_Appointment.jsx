...
const Book_Appointment = () => {
  ...
  const HandleOnsubmitBookAppointment=(e)=>{
    e.preventDefault();
    if(!BookAppoint.patientName){
      alert('Please Enter Name');
      return;
    }

    console.log(BookAppoint);
    axios.post('http://localhost:5000/AddBook',{BookAppoint}).then(alert("inserted"));
  }
  return (
    <>
      <ToastContainer />
      <div className="container">
        ...
        <div className="AfterSideBar">
          <div className="Main_Add_Doctor_div">
            ...
            <form onSubmit={HandleOnsubmitBookAppointment}>
              {/* Name PlaceHolder */}
              <div>
