...
const Add_Patient = () => {
  ...
  const HandleOnsubmitAppointment1=(e)=>{
    ...
    axios.post('http://localhost:5000/patient',{AddPatient}).then(alert("inserted"));
  }
      ...
      <div className="container">
        ...
        <div className="AfterSideBar">
          <div className="Main_Add_Doctor_div">
            ...
            <form onSubmit={HandleOnsubmitAppointment1}>
              {/* Name PlaceHolder */}
              <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, patientName:e.target.value})}
                  />
                </div>
              </div>
              {/* AGE PLACEHOLDER  */}
              <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, age:e.target.value})}
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, email:e.target.value})}
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="inputdiv">
                  <select
                    ...
                    onChange={e=>setAddPatient({...AddPatient, gender:e.target.value})}
                    required
                  >
              ...
              <div className="dateofAppointment">
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, DOB:e.target.value})}
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, mobile:e.target.value})}
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, details:e.target.value})}
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, disease:e.target.value})}
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, address:e.target.value})}
                    required
                  />
                </div>
              </div>
              ...
              {/* <div>
                ...
                <div className="inputdiv">
                  <input
                    ...
                    onChange={e=>setAddPatient({...AddPatient, roomNumber:e.target.value})}
                    required
                  />
                </div>
              </div> */}
              ...
              <div>
                ...
                <div className="inputdiv">
                  <select
                    ...
                    onChange={e=>setAddPatient({...AddPatient, department:e.target.value})}
                    required
                  >
              ...
              <div>
                ...
                <div className="inputdiv">
                  <select
                    ...
                    onChange={e=>setAddPatient({...AddPatient, docID:e.target.value})}
                    required
                  >
              ...
              <div>
                ...
                <div className="inputdiv">
                  <select
                    name="bloodGroup"
                    onChange={e=>setAddPatient({...AddPatient, bloodGroup:e.target.value})}
                    required
                  >
                    <option value="">Select</option>
